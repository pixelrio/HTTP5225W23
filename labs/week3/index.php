...
<html>
    ...
    <body>
        ...
        if($grade <= 59){
            echo '<h1>Sorry, you failed. You got a F Grade: ' . $grade . '</h1>';
        }
        elseif($grade >= 60 && $grade < 70){
            echo '<h1>You barely Passed: C Grade ' . $grade . '</h1>';
        }
        elseif($grade >= 71 && $grade < 80){
            echo '<h1>You Passed: B Grade' . $grade . '</h1>';
        }
        elseif($grade >= 81 && $grade < 91){
            echo '<h1>You Passed: A Grade' . $grade . '</h1>';
        }elseif($grade >= 91){
            echo '<h1>You Passed with flying color: A+ Grade ' . $grade . '</h1>';
        }
